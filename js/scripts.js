$(document).ready(function () {
    ...
    let dataAreaOffset = $('#skill-area').offset();
    ...
    setTimeout(function() {
        ...
        $('#skill-area').parallax({imageSrc: './img/pattern.png'});
    ...
    let servicesSection = $('#course-area');
    let teamSection = $('#skills-area');
    let portfolioSection = $('#contact-area');
    let contactSection = $('#project-area');
